		...
		if (length && length > 2 && data[0] == '4' && data[1] == '2')
		{
			...
			if (s != "")
			{
				...
				if (event == "telemetry")
				{
					...
					double front_car_speed = 50.0;
					double left_car_speed = 50.0;
					double right_car_speed = 50.0;
					...
					if (too_close)
					{
						...
						if (lane == 1)
						{
							if (left_car_speed >= right_car_speed && left_car_speed > front_car_speed && car_in_left == false)
							{
								lane--;
							}
							else if (right_car_speed > left_car_speed && right_car_speed > front_car_speed && car_in_right == false)
							{
								lane++;
							}
						}
						...
						{
							if (right_car_speed > front_car_speed && car_in_right == false)
							{
								lane++;
							}
						}
						...
						{
							if (left_car_speed > front_car_speed && car_in_left == false)
							{
								lane--;
							}
						}
						// // if driving in lane 1 or 2 and there is no car in left lane
						// if (lane != 0 && car_in_left == false)
						// {
						// 	// go to left lane
						// 	lane--;
						// }
						// // if driving in lane 0 or 1 and there is no car in right lane
						// else if (lane != 2 && car_in_right == false)
						// {
						// 	// go to right lane
						// 	lane++;
						// }
					...
					else
					{
						...
						//use 2 points that make the path tangent to the previous path's endpoint
					...
					//calculate how to break up spline points so we travel at our desired ref velocity
